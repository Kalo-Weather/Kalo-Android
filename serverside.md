...
const SECRET = process.env.KALO_CLIENT_APP_SECRET || 'kalo_test_secret_key';
...
SECRET = os.getenv('KALO_CLIENT_APP_SECRET', 'kalo_test_secret_key')
...
class KaloWeatherClient {
  ...
  KaloWeatherClient({
    ...
    this.clientSecret = 'kalo_test_secret_key',
